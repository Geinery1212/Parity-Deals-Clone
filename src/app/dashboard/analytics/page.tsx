...
async function ViewsByCard(
    props: Parameters<typeof getViewsByChartData>[0]
) {
    const chartData = await getViewsByChartData(props)

    return (
        <Card>
            <CardHeader>
                <CardTitle>Visitors Per Group</CardTitle>
            </CardHeader>
            <CardContent>
                <ViewsByChart chartData={chartData} />
            </CardContent>
        </Card>
    )
}
