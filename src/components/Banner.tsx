...
export function Banner({
    ...
    return (
        ...
        `}
            ...
            <div className={`${prefix}pdc-container ${prefix}pdc-override`}>
                <span
                    className={`${prefix}pdc-message ${prefix}pdc-override`}
